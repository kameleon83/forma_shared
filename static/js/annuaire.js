...
$(function() {
    ...
    $('section > .row').prepend('<div class="number_annuaire">Nombres de contacts.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total : <b class="total">' + total + '</b>&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;Formateur : <b class="formateur">' + formateur + '</b>&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;Elèves : <b class="eleves">' + eleve + '</b></div>');
